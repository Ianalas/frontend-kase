...
export function RelacaoAlunos() {
  ...
  return (
    <Section className="w-3/4 min-h-full flex flex-col mb-24">
        ...
        <Table className="w-full p-6">
          <TableHeader className="bg-accent">
            <TableRow>
              ...
              <TableHead className="w-44"><p className="font-semibold text-gray-300 text-center">Data entrada</p></TableHead>
              <TableHead className="w-24"/>
              <TableHead className="w-48"><p className="font-semibold text-gray-300">CPF</p></TableHead>
              <TableHead className="w-52"><p className="font-semibold text-gray-300 text-center">Data de nascimento</p></TableHead>
      ...
      {showForm && (
        <FormNewAluno onClose={() => setShowForm(false)} />
      )}
